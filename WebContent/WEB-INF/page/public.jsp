<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html ng-app="publicApp" ng-controller="publicController">
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="/themes/angularController/publicController.js" ></script>
...
<body>
	...
	<div class="menu">
		<ul>
			...
			<li id="menu_3" class="active" ><a href="/public.html" ><img src="/themes/img/small_menue_03.png"/>公益课堂</a></li>
	...
	<!--左侧导航 	end-->
	<div class="banner_img"><a href="#" ><img src="/themes/img/public_banner.png"/></a></div>
	<div class="swiper-container slide-content" style="display: none;" >
	...
	<div class="content">
		<div class="recommend-list">
			<div class="recommend-col" ng-repeat="publicItem in recommendList">
				<a  ng-attr-href = "{{publicItem.url}}">
					<div class="recommend-left"><img ng-attr-src="{{publicItem.publicPicUrl}}"/></div>
					<div class="recommend-right">
						<h3>{{publicItem.publicTitle}}</h3>
						<p>{{publicItem.publicDesc}}</p>
					</div>
				</a>
			</div>
		</div>

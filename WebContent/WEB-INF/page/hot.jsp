<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html ng-app="hotApp" ng-controller="hotController">
<head>
    <meta charset="utf-8">
    ...
    <script src="/themes/angularController/hotController.js" ></script>
</head>
<body>
	<!--头部导航 	start-->
	<div class="back">
	...
	<div class="menu">
		<ul>
			...
			<li id="menu_9" class="active" ><a href="/hot.html" ><img src="/themes/img/small_menue_09.png"/>热门活动</a></li>
		</ul>
	</div>
	<!--左侧导航 	end-->
	<div class="banner_img"><a href="http://mp.weixin.qq.com/s?__biz=MzA3MjI5MTMxNg==&mid=402687918&idx=1&sn=e3c99a460512c75b7c390aea759eae22&scene=4#wechat_redirect" ><img src="/themes/img/activity_banner.png"/></a></div>
	
	<!--tab切换		start-->
	<div class="train-content">
		<div class="tabs">
			<a href="#" class="active">最新活动</a>
			<a href="#">活动报名</a>
		</div>	
		<div class="swiper-container">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<iframe height="600" allowTransparency="true" style="width:100%;border:none;overflow:auto;" frameborder="0" src="http://form.mikecrm.com/f.php?t=maxNBP"></iframe>
				</div>
			</div>
		</div>
	</div>

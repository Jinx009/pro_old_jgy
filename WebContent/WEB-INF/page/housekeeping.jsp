<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html ng-app="housekeepingApp" ng-controller="housekeepingController">
<head>
    <meta charset="utf-8">
    ...
    <script type="text/javascript" src="/themes/angularController/housekeepingController.js"></script>
...
<body>
	...
	<div class="menu">
		<ul>
			...
			<li id="menu_4" class="active" ><a href="/housekeeping.html" ><img src="/themes/img/small_menue_04.png"/>jg365巾帼家政</a></li>
	...
	<!--左侧导航 	end-->
	<div class="banner_img"><a href="http://mp.weixin.qq.com/s?__biz=MzA3MjI5MTMxNg==&mid=10000046&idx=1&sn=32e244fc52a1d9e0477b950d857f755f&scene=18&from=singlemessage&isappinstalled=0#wechat_redirect" ><img src="/themes/img/housekeeping_banner.png"/></a></div>

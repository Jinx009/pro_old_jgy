<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html ng-app="womanApp" ng-controller="womanController">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <title>NGO女性社会组织</title>
    ...
    <script type="text/javascript" src="/themes/angularController/womanController.js" ></script>
...
<body>
	...
	<div class="menu">
		<ul>
			...
			<li id="menu_7" class="active" ><a href="/woman.html" ><img src="/themes/img/small_menue_07.png"/>NGO女性社会组织</a></li>
	...
	<!--左侧导航 	end-->
	<div class="banner_img"><a href="http://mp.weixin.qq.com/s?__biz=MzAwMDMwNzc3MA==&amp;mid=207430617&amp;idx=1&amp;sn=09a4fe099bdb8d2bb8371644066152d2&amp;scene=18#wechat_redirect" ><img src="/themes/img/woman_NGO_banner.png"/></a></div>
